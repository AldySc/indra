          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Edit Data Kelas <?php echo $data['nama_kelas']; ?></h5>
              </div>
              <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" name="kompetensi_keahlian" value="<?php echo $data['kompetensi_keahlian']; ?>" required="" />
                      </div>
                    </div>
                  </div>
                   </section>
