                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" name="tahun" autofocus="" required="" />
                      </div>
                    </div>
                       <div class="form-group">
                        <label>Nominal</label>
                      ...
                      <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" name="nominal" autofocus="" required="" />
                      </div>
                    </div>
                  </div>
                   </section>
