          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Edit Data Pengguna <?php echo $data['username']; ?></h5>
              </div>
              <div class="card-body">
                 <form method="POST" action="proses_editpengguna.php" enctype="multipart/form-data" >
                  <section class="base">
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" name="nama" value="<?php echo $data['nama_petugas']; ?>" required="" />
                      </div>
                    </div>
                     <div class="form-group">
                    <label>level</label>
