          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="title">Tambah Kelas</h5>
              </div>
              <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" name="nama_kelas" autofocus="" required="" />
                      </div>
                    </div>
                       <div class="form-group">
                        <label>Jurusan</label>
                      ...
                      <div class="input-group-prepend">
                        ...
                        <input type="text" class="form-control" name="kompetensi_keahlian" autofocus="" required="" />
                      </div>
                    </div>
                  </div>
                   </section>
