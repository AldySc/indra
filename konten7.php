        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                  ...
                  <button class="btn btn-warning" type="submit"><i class="fas fa-search fa-fw"></i></button>
                </form>
              ...
              <div class="card-body">
                 ...
                 <?php
                    ...
                    <div class="card-footer">
                      <button type="submit" class="btn btn-fill btn-warning"><i class="fas fa-download"></i></button>
                    </div>
                </form>
              </div>
            </div>
